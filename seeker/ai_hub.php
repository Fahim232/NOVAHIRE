...
<head>
    ...
    .ai-nav{background:rgba(255,255,255,.92);backdrop-filter:blur(20px);border-bottom:1px solid rgba(226,232,240,.5);position:sticky;top:0;z-index:9990; margin-top: 10px;}
    ...
    .ai-brand-text span{background:var(--ai-grad);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;}
...
<div class="ai-section">
    ...
    <div class="ai-features">
        ...
        <a href="ai_cv_generator.php" class="ai-fcard">
            <span class="ai-fcard-tag" style="background:rgba(16,185,129,.08);color:#10b981;">New</span>
            <div class="ai-fcard-icon" style="background:rgba(16,185,129,.1);color:#10b981;"><i class="fas fa-wand-magic-sparkles"></i></div>
            <h5>Automated AI CV Generator</h5>
            <p>Generate a professional A4 CV. Live preview, inline editing, and AI rewriting of your summary and bullet points.</p>
